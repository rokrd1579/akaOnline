...
<div class="container-fluid">
                    ...
                    <div class="card shadow mb-4 ">
                        <div class="card-header d-sm-flex py-3 justify-content-between bg-primary">
                            <h4 class="m-0 font-weight-bold text-white">Editar categoría {{$category->id}}</h4>
                                  </div>
                                    <div class="card-body">
                                          ...
                                          <form action="{{route('admin.category.update', $category->id)}}" method="POST" enctype="multipart/form-data">
                                              ...
                                              <div class="modal-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" minlength="4" minlength="80" class="@error('category_name') is-invalid @enderror form-control rounded-pill" id="category_name" name="category_name" placeholder="Nombre" value="{{$category->category_name}}">
                                                    @error('category_name')
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="file-loading shadow-sm">
                                                        <input id="input-res-1" name="image" multiple accept="image/*" class="text-center" type="file" value="{{$category->image}}">
                                                    </div>
                                                </div>
                                                <div class="card card-primary shadow mb-4">
                                                            <div class="card-header d-sm-flex py-3 justify-content-between bg-gradient-primary">
                                                                <h6 class="m-0 font-weight-bold text-white">Imagen de: {{$category->category_name}}</h6>
                                                            </div>
                                                            <div class="card-body" id="app">
                                                                <div class="form-row">
                                                                    <div class="col-sm-3">
                                                                        <a href="{{$category->image}}" data-toggle="lightbox" data-title=" {{$category->category_name}}" data-gallery="gallery">
                                                                            <img style="width:200px; height:200px;" src="{{$category->image}}"class="img-fluid mb-2 shadow-sm" />
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            </div>
