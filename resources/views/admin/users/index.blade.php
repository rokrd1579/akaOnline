 ...
 <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4 ">
                        <div class="card-header d-sm-flex py-3 justify-content-between bg-primary">
                            <h4 class="m-0 font-weight-bold text-white">Registros de usuarios</h4>
                            <a href="{{route('admin.users.create')}}" class="Addusers d-sm-inline-block btn btn-sm btn-primary shadow-sm rounded-pill"  
                            ...
                            <table class="table table-bordered text-center table-hover" id="tableusers" width="100%" cellspacing="0">
                                    <thead class="bg-primary text-white">
                                        <tr>
                                            ...
                                            <th style="width: 30%">Dirección de correo electrónico</th>
                                    ...
                                    @foreach($users as $user)
                                        <tr>
                                            ...
                                            <td class="aling-middle">
                                                <form action="{{route('admin.users.destroy', $user->id)}}" class="Deleteuser" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <a href="{{route('admin.users.show', $user->id)}}" class="btn btn-warning btn-circle shadow-sm  btn-xl"
                                                        data-toggle="popover" title="Detalle!"> 
                                                        <i class="fa fa-info-circle"></i>
                                                    </a>
                                                    <a href="{{route('admin.users.edit', $user->id)}}" class="Addusers btn btn-primary btn-circle  shadow-sm  btn-xl"
