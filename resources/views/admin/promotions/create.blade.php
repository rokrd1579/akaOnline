                                    ...
                                    <div class="card shadow mb-4 ">
                                        <div>
                                            <div class="card-header d-sm-flex py-3 justify-content-between bg-primary">
                                                <h4 class="m-0 font-weight-bold text-white">Agregar nueva promoción</h4>
                                            </div>
                                                <div class="card-body">
                                                        <form action="{{route('admin.promotions.store')}}" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-row">
                                                                <div class="form-group col-md-3">
                                                                    ...
                                                                    <input type="text" minlength="5" maxlength="55" class="@error('name') is-invalid @enderror form-control rounded-pill" id="name" name="name" placeholder="" value="{{old('name')}}">
                                                                    @error('name')
                                                                ...
                                                                <div class="form-group col-md-3">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="number" class="@error('discount') is-invalid @enderror form-control text-center" id="num" name="discount" min="1" max="99"  placeholder="" value="{{old('discount')}}">
                                                                ...
                                                                <div class="form-group col-md-6">
                                                                    ...
                                                                    <input type="text" minlength="10" maxlength="80" class="@error('description') is-invalid @enderror form-control rounded-pill" id="name" name="description" placeholder="" value="{{old('description')}}">
                                                                    @error('description')
                                                                        <span class="invalid-feedback" role="alert">
                                                                            <strong>{{ $message }}</strong>
                                                                        </span>
                                                            ...
                                                            <div class="form-row">
                                                                ...
                                                                <div class="form-group col-md-4">
                                                                    <label for="example-datetime-local-input" class="">Inicio de promoción</label>
                                                                        <input class="@error('stard_date') is-invalid @enderror form-control rounded-pill" type="datetime-local" name="stard_date" value="{{old('stard_date')}}" placeholder="2011-08-19T13:45:00" id="example-datetime-local-input">
                                                                        @error('stard_date')
                                                                        <span class="invalid-feedback" role="alert">
                                                                            <strong>{{ $message }}</strong>
                                                                        </span>
                                                                ...
                                                                <div class="form-group col-md-4">
                                                                    ...
                                                                    <input class="@error('finish_date') is-invalid @enderror form-control rounded-pill" type="datetime-local" name="finish_date" value="{{old('finish_date')}}" placeholder="2011-08-19T13:45:00" id="example-datetime-local-input">
                                                                    @error('finish_date')
                                                                        <span class="invalid-feedback" role="alert">
                                                                            <strong>{{ $message }}</strong>
                                                                        </span>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="input-res-1">Agregar imágen</label>
                                                                <div class="file-loading shadow-sm">
                                                                    <input id="input-res-1" name="image" required accept="image/*" class="text-center" type="file">
                                                                </div>
                                                            </div>
                                                            <br>
